...
<div class="right">
       ...
       <form method="get" action="${pageContext.request.contextPath }/Bill/query">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/Bill/toBillAdd">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<span><a class="deleteBill" href="${pageContext.request.contextPath}/Bill/delbill/${bill.id}"><img src="${pageContext.request.contextPath }/images/schu.png" alt="删除" title="删除"/></a></span>
					</td>
				</tr>
			</c:forEach>
      </table>
